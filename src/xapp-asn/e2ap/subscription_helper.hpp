...
public:
  ...
  void add_action(int id, int type, const void *action_def, size_t size, int next_action, int time_to_wait){
    Action a (id, type, action_def, size, next_action, time_to_wait);
    _action_ref.get()->push_back(a);
  };
